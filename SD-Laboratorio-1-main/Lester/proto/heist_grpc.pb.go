...
func (c *heistServiceClient) SolicitarOferta(ctx context.Context, in *Solicitud, opts ...grpc.CallOption) (*Oferta, error) {
	...
	out := new(Oferta)
	err := c.cc.Invoke(ctx, HeistService_SolicitarOferta_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *heistServiceClient) AceptarOferta(ctx context.Context, in *Decision, opts ...grpc.CallOption) (*Respuesta, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Respuesta)
	err := c.cc.Invoke(ctx, HeistService_AceptarOferta_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedHeistServiceServer must be embedded to have
...
func (UnimplementedHeistServiceServer) testEmbeddedByValue()                      {}
...
func RegisterHeistServiceServer(s grpc.ServiceRegistrar, srv HeistServiceServer) {
	// If the following call pancis, it indicates UnimplementedHeistServiceServer was
